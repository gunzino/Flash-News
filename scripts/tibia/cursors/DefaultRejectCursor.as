package tibia.cursors
{
   ...
   public class DefaultRejectCursor
   {
      ...
      public static const CURSOR_NAME:String = CURSOR_DEFAULT_REJECT_NAME;
      ...
      private static const CURSOR_CLASS:Class = DefaultRejectCursor_CURSOR_CLASS;
      ...
      public function DefaultRejectCursor()
      {
         super();
      }
