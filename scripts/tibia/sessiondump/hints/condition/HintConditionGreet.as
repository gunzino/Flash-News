...
{
   public class HintConditionGreet extends HintConditionBase
   {
      ...
      public static const TYPE:String = "GREET";
      ...
      public function HintConditionGreet()
      {
         super();
         m_Type = TYPE;
      }
      
      public static function s_Unmarshall(param1:Object) : HintConditionGreet
      {
         var _loc2_:HintConditionGreet = null;
         if(param1 != null && FIELD_CREATURE_NAME in param1)
         {
            _loc2_ = new HintConditionGreet();
            _loc2_.m_CreatureName = param1[FIELD_CREATURE_NAME] as String;
            return _loc2_;
         }
         throw new ArgumentError("HintConditionGreet.s_Unmarshall: Invalid hint data");
      }
