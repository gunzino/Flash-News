...
{
   public class HintConditionAttack extends HintConditionBase
   {
      ...
      public static const TYPE:String = "ATTACK";
      ...
      private var m_CreatureName:String = null;
      
      public function HintConditionAttack()
      {
         super();
         m_Type = TYPE;
      }
      
      public static function s_Unmarshall(param1:Object) : HintConditionAttack
      {
         var _loc2_:HintConditionAttack = null;
         if(param1 != null && FIELD_CREATURE_NAME in param1)
         {
            _loc2_ = new HintConditionAttack();
            _loc2_.m_CreatureName = param1[FIELD_CREATURE_NAME] as String;
            return _loc2_;
         }
         throw new ArgumentError("HintConditionAttack.s_Unmarshall: Invalid hint data");
      }
      
      public function get creatureName() : String
      {
         return this.m_CreatureName;
      }
   }
}
