package mx.preloaders
{
   ...
   public class Preloader extends Sprite
   {
      ...
      private function getByteValues() : Object
      {
         ...
         var _loc4_:int = !!rslListLoader?int(rslListLoader.getItemCount()):0;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc2_ = _loc2_ + rslListLoader.getItem(_loc5_).loaded;
            _loc3_ = _loc3_ + rslListLoader.getItem(_loc5_).total;
            _loc5_++;
         }
         return {
            "loaded":_loc2_,
