package mx.preloaders
{
   ...
   public class DownloadProgressBar extends Sprite implements IPreloaderDisplay
   {
      ...
      protected function createChildren() : void
      {
         ...
         _loc1_.drawRoundRect(calcX(_borderRect.x),calcY(_borderRect.y),_borderRect.width,_borderRect.height,_borderRect.cornerRadius * 2,_borderRect.cornerRadius * 2);
         _loc1_.drawRoundRect(calcX(_borderRect.x + 1),calcY(_borderRect.y + 1),_borderRect.width - 2,_borderRect.height - 2,_borderRect.cornerRadius - 1 * 2,_borderRect.cornerRadius - 1 * 2);
         _loc1_.endFill();
         _loc1_.beginFill(13421772,0.4);
         _loc1_.drawRoundRect(calcX(_borderRect.x + 1),calcY(_borderRect.y + 1),_borderRect.width - 2,_borderRect.height - 2,_borderRect.cornerRadius - 1 * 2,_borderRect.cornerRadius - 1 * 2);
         _loc1_.endFill();
         ...
         _loc5_.createGradientBox(_barFrameRect.width,_barFrameRect.height,Math.PI / 2,calcX(_barFrameRect.x),calcY(_barFrameRect.y));
         _loc4_.beginGradientFill(GradientType.LINEAR,[6054502,11909306],[1,1],[0,255],_loc5_);
         _loc4_.drawRoundRect(calcX(_barFrameRect.x),calcY(_barFrameRect.y),_barFrameRect.width,_barFrameRect.height,_barFrameRect.cornerRadius * 2,_barFrameRect.cornerRadius * 2);
         _loc4_.drawRoundRect(calcX(_barFrameRect.x + 1),calcY(_barFrameRect.y + 1),_barFrameRect.width - 2,_barFrameRect.height - 2,_barFrameRect.cornerRadius * 2,_barFrameRect.cornerRadius * 2);
         _loc4_.endFill();
         ...
         _loc1_.lineTo(calcX(_borderRect.x) - _borderRect.cornerRadius + _borderRect.width,calcY(_borderRect.y));
      }
      ...
      private function initBackgroundImage(param1:DisplayObject) : void
      {
         ...
         {
            _loc9_ = _loc4_ * 0.01;
            _loc7_ = _loc9_ * stageWidth / _loc2_;
      ...
      private function drawProgressBar(param1:Number) : void
      {
         ...
         var _loc5_:Matrix = new Matrix();
         var _loc6_:Number = _barRect.width * param1 / 100;
         var _loc7_:Number = _loc6_ / 2;
         var _loc8_:Number = _barRect.height - 4;
         ...
         _loc7_ = _loc6_ / 3;
         _loc8_ = _barRect.height;
         _loc10_ = calcY(_barRect.y);
...
class ErrorField extends Sprite
{
   ...
   public function show(param1:String) : void
   {
      ...
      var _loc2_:Number = downloadProgressBar.stageWidth;
      var _loc3_:Number = downloadProgressBar.stageHeight;
      ...
      _loc4_.text = param1;
      _loc4_.width = Math.max(MIN_WIDTH_INCHES * Capabilities.screenDPI,_loc2_ - TEXT_MARGIN_PX * 2);
      _loc4_.width = Math.min(MAX_WIDTH_INCHES * Capabilities.screenDPI,_loc4_.width);
