   ...
   public class ScrollControlBase extends UIComponent
   {
      ...
      protected function setScrollBarProperties(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ == ScrollPolicy.ON || param2 < param1 && param1 > 0 && _loc5_ == ScrollPolicy.AUTO)
         {
            ...
            _loc7_ = roomForScrollBar(horizontalScrollBar,unscaledWidth,unscaledHeight);
            if(_loc7_ != horizontalScrollBar.visible)
            {
         ...
         else if((_loc5_ == ScrollPolicy.AUTO || _loc5_ == ScrollPolicy.OFF) && horizontalScrollBar && horizontalScrollBar.visible)
         {
         ...
         if(_loc6_ == ScrollPolicy.ON || param4 < param3 && param3 > 0 && _loc6_ == ScrollPolicy.AUTO)
         {
            ...
            _loc7_ = roomForScrollBar(verticalScrollBar,unscaledWidth,unscaledHeight);
            if(_loc7_ != verticalScrollBar.visible)
            {
         ...
         else if((_loc6_ == ScrollPolicy.AUTO || _loc6_ == ScrollPolicy.OFF) && verticalScrollBar && verticalScrollBar.visible)
         {
      ...
      public function get maxVerticalScrollPosition() : Number
      {
         ...
         var _loc1_:Number = !!verticalScrollBar?Number(verticalScrollBar.maxScrollPosition):Number(0);
         return _loc1_;
      }
      ...
      public function set horizontalScrollPolicy(param1:String) : void
      {
         ...
         if(_horizontalScrollPolicy != _loc2_)
         {
            _horizontalScrollPolicy = _loc2_;
      ...
      protected function mouseWheelHandler(param1:MouseEvent) : void
      {
         ...
         if(verticalScrollBar && verticalScrollBar.visible)
         {
            ...
            verticalScrollPosition = verticalScrollPosition + 3 * _loc3_ * _loc2_;
         ...
         if(param1 is ScrollEvent)
         {
            ...
            else if(ScrollEvent(param1).detail == ScrollEventDetail.THUMB_TRACK)
            {
               ...
               if(!scrollTip)
               {
                  ...
                  scrollThumbMidPoint = _loc2_.scrollThumb.height / 2;
               ...
               else
               {
                  ...
                  if(_loc3_)
                  {
                     ...
                     _loc7_.y = _loc2_.scrollThumb.y + scrollThumbMidPoint - scrollTip.height / 2;
                  }
                  else
                  {
                     _loc7_.x = -3 - scrollTip.height;
                     _loc7_.y = _loc2_.scrollThumb.y + scrollThumbMidPoint - scrollTip.width / 2;
                  }
      ...
      public function get maxHorizontalScrollPosition() : Number
      {
         ...
         var _loc1_:Number = !!horizontalScrollBar?Number(horizontalScrollBar.maxScrollPosition):Number(0);
         return _loc1_;
      }
      ...
      {
         var _loc2_:String = param1.toLowerCase();
         if(_verticalScrollPolicy != _loc2_)
         {
