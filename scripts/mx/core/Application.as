package mx.core
{
   ...
   public class Application extends LayoutContainer
   {
      ...
      private function printCreationQueue() : void
      {
         ...
         var _loc1_:String = "";
         var _loc2_:Number = creationQueue.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      public function addToCreationQueue(param1:Object, param2:int = -1, param3:Function = null, param4:IFlexDisplayObject = null) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc12_:int = 0;
         var _loc5_:int = creationQueue.length;
         var _loc6_:Object = {};
      ...
      override mx_internal function initThemeColor() : Boolean
      {
         ...
         if(!_loc1_)
         {
            _loc5_ = StyleManager.getStyleDeclaration("global");
            if(_loc5_)
            {
      ...
      override public function get viewMetrics() : mx.core.EdgeMetrics
      {
         ...
         if(controlBar && controlBar.includeInLayout)
         {
            ...
            _loc1_.top = _loc1_.top + Math.max(controlBar.getExplicitOrMeasuredHeight(),_loc3_);
         }
         return _loc1_;
      }
