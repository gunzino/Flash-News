package mx.formatters
{
   ...
   public class StringFormatter
   {
      ...
      public function formatValue(param1:Object) : String
      {
         ...
         var _loc5_:int = patternInfo.length;
         var _loc6_:int = 1;
         while(_loc6_ < _loc5_)
         {
            _loc2_ = patternInfo[_loc6_];
            _loc3_ = _loc3_ + (reqFormat.substring(_loc4_.end,_loc2_.begin) + extractToken(param1,_loc2_));
            _loc4_ = _loc2_;
            _loc6_++;
         }
         if(_loc4_.end > 0 && _loc4_.end != reqFormat.length)
         {
            _loc3_ = _loc3_ + reqFormat.substring(_loc4_.end);
         }
         return _loc3_;
      }
      ...
      private function formatPattern(param1:String, param2:String) : void
      {
         ...
         while(_loc8_ < _loc7_)
         {
            ...
            {
               _loc4_ = reqFormat.lastIndexOf(_loc6_[_loc8_]);
               _loc4_ = _loc4_ >= 0?int(_loc4_ + 1):int(_loc3_ + 1);
