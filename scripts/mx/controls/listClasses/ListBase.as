   ...
   public class ListBase extends ScrollControlBase implements IDataRenderer, IFocusManagerComponent, mx.controls.listClasses.IListItemRenderer, IDropInListItemRenderer, IEffectTargetHost
   {
      ...
      protected function clearSelected(param1:Boolean = false) : void
      {
         ...
         for(_loc2_ in selectedData)
         {
            ...
            _loc4_ = UIDToItemRenderer(itemToUID(_loc3_));
            if(_loc4_)
            {
      ...
      protected function mouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         if(isPressed && mouseDownPoint && (Math.abs(mouseDownPoint.x - _loc2_.x) > DRAG_THRESHOLD || Math.abs(mouseDownPoint.y - _loc2_.y) > DRAG_THRESHOLD))
         {
         ...
         if(_loc3_ && highlightItemRenderer)
         {
         ...
         else if(!_loc3_ && highlightItemRenderer)
         {
            if(!isPressed)
            {
      ...
      override public function set verticalScrollPosition(param1:Number) : void
      {
         ...
         if(_loc2_ != param1)
         {
            ...
            if(_loc5_ >= rowInfo.length - offscreenExtraRows || !iteratorValid)
            {
               clearIndicators();
               clearVisibleData();
         ...
         addClipMask(offscreenExtraRowsTop != _loc3_ || offscreenExtraRowsBottom != _loc4_);
      }
      ...
      protected function itemRendererToIndices(param1:mx.controls.listClasses.IListItemRenderer) : Point
      {
         ...
         var _loc2_:int = rowMap[param1.name].rowIndex;
         var _loc3_:int = listItems[_loc2_].length;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      private function reduceRows(param1:int) : void
      {
         ...
         while(param1 >= 0)
         {
            ...
            {
               _loc2_ = listItems[param1].length;
               _loc3_ = 0;
               while(_loc3_ < _loc2_)
               {
      ...
      override public function set horizontalScrollPosition(param1:Number) : void
      {
         ...
         if(_loc2_ != param1)
         {
            ...
            if(bColumnScrolling && _loc3_ >= columnCount)
            {
               clearIndicators();
               clearVisibleData();
      ...
      public function isItemHighlighted(param1:Object) : Boolean
      {
         ...
         var _loc2_:Boolean = highlightIndicator && highlightIndicator.parent.getChildIndex(highlightIndicator) != highlightIndicator.parent.numChildren - 1;
         if(param1 is String)
         {
      ...
      mx_internal function clearHighlight(param1:mx.controls.listClasses.IListItemRenderer) : void
      {
         ...
         if(_loc3_ && lastHighlightItemIndices)
         {
            _loc4_ = new ListEvent(ListEvent.ITEM_ROLL_OUT);
            _loc4_.columnIndex = lastHighlightItemIndices.x;
            _loc4_.rowIndex = lastHighlightItemIndices.y;
            _loc4_.itemRenderer = lastHighlightItemRendererAtIndices;
            dispatchEvent(_loc4_);
      ...
      protected function updateList() : void
      {
         ...
         if(iterator)
         {
            if(int(offscreenExtraColumns) || int(offscreenExtraColumnsLeft) || offscreenExtraColumnsRight)
            {
      ...
      protected function mouseUpHandler(param1:MouseEvent) : void
      {
         ...
         {
            _loc4_ = new ListEvent(ListEvent.CHANGE);
            _loc4_.itemRenderer = mouseDownItem;
      ...
      protected function dragScroll() : void
      {
         ...
         if(mouseY < _loc1_)
         {
            ...
            dragScrollingInterval = setInterval(dragScroll,_loc2_);
         ...
         if(DragManager.isDragging && lastDragEvent && _loc3_ != verticalScrollPosition)
         {
      ...
      override protected function measure() : void
      {
         ...
         var _loc2_:int = explicitColumnCount < 1?int(defaultColumnCount):int(explicitColumnCount);
         var _loc3_:int = explicitRowCount < 1?int(defaultRowCount):int(explicitRowCount);
      ...
      private function removeSelectionData(param1:String) : void
      {
         ...
         {
            lastSelectionData = _loc2_.prevSelectionData;
         }
      ...
      override public function validateDisplayList() : void
      {
         ...
         if(invalidateDisplayListFlag)
         {
            ...
            if(runDataEffectNextUpdate)
            {
               ...
               initiateDataChangeEffect(scaleX == 0?Number(0):Number(width / scaleX),scaleY == 0?Number(0):Number(height / scaleY));
            }
            else
            {
               updateDisplayList(scaleX == 0?Number(0):Number(width / scaleX),scaleY == 0?Number(0):Number(height / scaleY));
            }
      ...
      mx_internal function hasOnlyTextRenderers() : Boolean
      {
         ...
         var _loc1_:Array = listItems[listItems.length - 1];
      ...
      protected function sumRowHeights(param1:int, param2:int) : Number
      {
         ...
         while(_loc4_ <= param2)
         {
            _loc3_ = _loc3_ + rowInfo[_loc4_].height;
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      private function makeRowsAndColumnsWithExtraColumns(param1:Number, param2:Number) : void
      {
         ...
         var _loc7_:Number = !!offscreenExtraColumnsLeft?Number(listItems[0][offscreenExtraColumnsLeft - 1].x + columnWidth):Number(0);
         ...
         if(_loc4_ > 0 && !iterator.afterLast)
         {
            ...
            _loc10_ = listItems[0].length;
            _loc8_ = makeRowsAndColumns(_loc7_,0,_loc7_,listContent.height,offscreenExtraColumnsLeft + _loc8_.x,0,true,_loc4_);
            if(_loc8_.x < _loc4_)
            {
               _loc11_ = listItems[0].length - (_loc10_ + _loc8_.x);
               if(_loc11_)
               {
                  _loc12_ = 0;
         ...
         var _loc9_:Number = listContent.widthExcludingOffsets;
         listContent.leftOffset = -offscreenExtraColumnsLeft * columnWidth;
         listContent.rightOffset = offscreenExtraColumnsRight > 0?Number(listItems[0][listItems[0].length - 1].x + columnWidth - _loc9_ + listContent.leftOffset):Number(0);
      ...
      {
         selectionTween_updateHandler(param1);
      }
      ...
      protected function mouseOverHandler(param1:MouseEvent) : void
      {
         ...
         if(dragScrollingInterval != 0 && !param1.buttonDown)
         {
            mouseIsUp();
         }
         ...
         if(!isPressed || allowDragSelection)
         {
            ...
            if(getStyle("useRollOver") && _loc3_.data != null)
            {
               ...
               if(_loc4_)
               {
                  ...
                  lastHighlightItemRendererAtIndices = _loc3_;
               }
            }
         }
         else
      ...
      protected function finishKeySelection() : void
      {
         ...
         if(lastKey == Keyboard.PAGE_DOWN)
         {
            if(_loc3_ - _loc4_ == 0)
            {
               caretIndex = Math.min(verticalScrollPosition + _loc3_ - _loc4_,collection.length - 1);
            }
            else
            {
               caretIndex = Math.min(verticalScrollPosition + _loc3_ - _loc4_ - 1,collection.length - 1);
            }
         }
         ...
         if(bSelectItem && caretIndex - verticalScrollPosition >= 0)
         {
            ...
            _loc5_ = listItems[caretIndex - verticalScrollPosition + offscreenExtraRowsTop][0];
            if(_loc5_)
            {
      ...
      mx_internal function addClipMask(param1:Boolean) : void
      {
         ...
         var _loc2_:int = listItems.length - 1;
         ...
         var _loc7_:Number = listContent.width;
         var _loc8_:Number = listContent.height - _loc3_.y;
         var _loc9_:int = 0;
         while(_loc9_ < _loc5_)
         {
            ...
            {
               _loc10_.mask = createItemMask(0,_loc6_ + _loc11_,_loc7_,_loc8_ - _loc11_);
            }
            _loc9_++;
         }
      }
      ...
      protected function prepareDataEffect(param1:CollectionEvent) : void
      {
         ...
         {
            _loc4_ = iterator.bookmark.getViewIndex();
            _loc5_ = _loc4_ + rowCount * columnCount - 1;
      ...
      protected function mouseDownHandler(param1:MouseEvent) : void
      {
         ...
         if(dragEnabled && selectedData[rowMap[_loc2_.name].uid])
         {
            bSelectOnRelease = true;
         }
      ...
      protected function drawItem(param1:mx.controls.listClasses.IListItemRenderer, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         if(param3 && (!highlightItemRenderer || highlightUID != _loc11_.uid))
         {
            ...
            lastHighlightItemRenderer = highlightItemRenderer = param1;
         ...
         if(param2)
         {
            _loc12_ = !!runningDataEffect?Number(param1.y - cachedPaddingTop):Number(_loc9_[_loc11_.rowIndex].y);
            if(!selectionIndicators[_loc11_.uid])
            {
               _loc6_ = new SpriteAsset();
               _loc6_.mouseEnabled = false;
               _loc10_.addChild(DisplayObject(_loc6_));
               selectionIndicators[_loc11_.uid] = _loc6_;
               drawSelectionIndicator(_loc6_,param1.x,_loc12_,param1.width,_loc9_[_loc11_.rowIndex].height,!!enabled?uint(getStyle("selectionColor")):uint(getStyle("selectionDisabledColor")),param1);
               if(param5)
               {
         ...
         {
            if(_loc11_ && selectionIndicators[_loc11_.uid])
            {
               if(selectionTweens[_loc11_.uid])
               {
                  selectionTweens[_loc11_.uid].removeEventListener(TweenEvent.TWEEN_UPDATE,selectionTween_updateHandler);
                  selectionTweens[_loc11_.uid].removeEventListener(TweenEvent.TWEEN_END,selectionTween_endHandler);
                  if(selectionIndicators[_loc11_.uid].alpha < 1)
                  {
                     Tween.removeTween(selectionTweens[_loc11_.uid]);
                  }
      ...
      override public function get baselinePosition() : Number
      {
         ...
         var _loc4_:IUIComponent = listItems[0][0] as IUIComponent;
         if(!_loc4_)
         {
            return super.baselinePosition;
         }
      ...
      private function makeRowsAndColumnsWithExtraRows(param1:Number, param2:Number) : void
      {
         ...
         var _loc12_:Number = !!offscreenExtraRowsTop?Number(rowInfo[offscreenExtraRowsTop - 1].y + rowHeight):Number(0);
         _loc7_ = makeRowsAndColumns(0,_loc12_,listContent.width,_loc12_ + listContent.heightExcludingOffsets,0,offscreenExtraRowsTop);
         if(_loc9_ > 0 && !iterator.afterLast)
         {
            ...
            _loc14_ = listItems.length;
            _loc7_ = makeRowsAndColumns(0,_loc12_,listContent.width,_loc12_,0,offscreenExtraRowsTop + _loc7_.y,true,_loc9_);
            if(_loc7_.y == _loc9_)
            {
               while(_loc7_.y > 0 && listItems[listItems.length - 1] && listItems[listItems.length - 1].length == 0)
               {
                  _loc7_.y--;
                  listItems.pop();
                  rowInfo.pop();
            ...
            {
               _loc15_ = listItems.length - (_loc14_ + _loc7_.y);
               if(_loc15_)
               {
                  _loc16_ = 0;
         ...
         var _loc13_:Number = listContent.heightExcludingOffsets;
         listContent.topOffset = -offscreenExtraRowsTop * rowHeight;
         listContent.bottomOffset = offscreenExtraRowsBottom > 0?Number(listItems[listItems.length - 1][0].y + rowHeight - _loc13_ + listContent.topOffset):Number(0);
         if(iteratorValid)
         {
         ...
         if(_loc2_ == listContent)
         {
            ...
            while(_loc6_ < _loc5_)
            {
               if(listItems[_loc6_].length)
               {
                  ...
                  {
                     _loc7_ = listItems[_loc6_].length;
                     if(_loc7_ == 1)
                     {
      ...
      protected function getReservedOrFreeItemRenderer(param1:Object) : mx.controls.listClasses.IListItemRenderer
      {
         ...
         else
         {
            ...
            if(freeItemRenderersByFactory)
            {
               ...
               {
                  _loc5_ = freeItemRenderersByFactory[_loc4_];
                  if(_loc5_)
                  {
      ...
      private function adjustAfterSort() : void
      {
         ...
         index = !!anchorBookmark?int(anchorBookmark.getViewIndex()):-1;
         if(index >= 0)
         {
            if(i == 1)
            {
      ...
      protected function adjustListContent(param1:Number = -1, param2:Number = -1) : void
      {
         ...
         var _loc3_:Number = viewMetrics.left + listContent.leftOffset;
      ...
      mx_internal function removeClipMask() : void
      {
         ...
         var _loc4_:Array = listItems[_loc1_];
         var _loc5_:int = _loc4_.length;
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
      ...
      public function showDropFeedback(param1:DragEvent) : void
      {
         ...
         if(!dropIndicator)
         {
            ...
            dropIndicator = IFlexDisplayObject(new _loc6_());
            _loc7_ = viewMetrics;
            drawFocus(true);
            dropIndicator.x = 2;
         ...
         var _loc2_:int = listItems.length;
         var _loc3_:int = rowInfo[_loc2_ - offscreenExtraRowsBottom - 1].y + rowInfo[_loc2_ - offscreenExtraRowsBottom - 1].height > listContent.heightExcludingOffsets - listContent.topOffset?1:0;
         var _loc4_:Number = calculateDropIndex(param1);
         _loc4_ = _loc4_ - verticalScrollPosition;
         ...
         dropIndicator.y = calculateDropIndicatorY(_loc5_,_loc4_ + offscreenExtraRowsTop);
      }
      ...
      protected function purgeItemRenderers() : void
      {
         ...
         while(listItems.length)
         {
            ...
            while(_loc2_.length)
            {
               ...
               if(_loc3_)
               {
                  ...
                  if(dataItemWrappersByRenderer[_loc3_])
                  {
         ...
         while(freeItemRenderers.length)
         {
            _loc4_ = DisplayObject(freeItemRenderers.pop());
            if(_loc4_.parent)
            {
         ...
         if(enabled && param1.dragSource.hasFormat("items"))
         {
            ...
            if(param1.action == DragManager.MOVE && dragMoveEnabled)
            {
               if(param1.dragInitiator == this)
               {
                  ...
                  while(_loc5_ >= 0)
                  {
                     collectionIterator.seek(CursorBookmark.FIRST,_loc4_[_loc5_]);
            ...
            collectionIterator.seek(CursorBookmark.FIRST,_loc3_);
            _loc5_ = _loc2_.length - 1;
            while(_loc5_ >= 0)
            {
               if(param1.action == DragManager.COPY)
               {
                  collectionIterator.insert(copyItemWithUID(_loc2_[_loc5_]));
               }
               else if(param1.action == DragManager.MOVE)
               {
                  collectionIterator.insert(_loc2_[_loc5_]);
               }
               _loc5_--;
            }
         }
      ...
      protected function get dragImageOffsets() : Point
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(selectedData[rowInfo[_loc3_].uid])
            {
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         else if(listContent && listItems)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc4_ = listItems[_loc3_].length;
               _loc5_ = 0;
               while(_loc5_ < _loc4_)
               {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         removeClipMask();
         var _loc4_:Graphics = selectionLayer.graphics;
         _loc4_.clear();
         ...
         adjustListContent(param1,param2);
         var _loc5_:Boolean = collection && collection.length > 0;
         if(_loc5_)
         {
      ...
      protected function dragCompleteHandler(param1:DragEvent) : void
      {
         ...
         if(param1.action == DragManager.MOVE && dragMoveEnabled)
         {
            if(param1.relatedObject != this)
            {
               ...
               while(_loc4_ >= 0)
               {
                  collectionIterator.seek(CursorBookmark.FIRST,_loc2_[_loc4_]);
                  collectionIterator.remove();
                  _loc4_--;
               }
               clearSelected(false);
