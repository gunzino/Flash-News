package mx.controls
{
   ...
   public class TextInput extends UIComponent implements IDataRenderer, IDropInListItemRenderer, IFocusManagerComponent, IIMESupport, IListItemRenderer, IFontContextComponent
   {
      ...
      override protected function measure() : void
      {
         ...
         super.measure();
         var _loc1_:EdgeMetrics = border && border is IRectangularBorder?IRectangularBorder(border).borderMetrics:EdgeMetrics.EMPTY;
      ...
      override public function get baselinePosition() : Number
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_3_0)
         {
            ...
            return (border && border is IRectangularBorder?IRectangularBorder(border).borderMetrics.top:0) + measureText(_loc1_).ascent;
         }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(border)
         {
            ...
            _loc3_ = border is IRectangularBorder?IRectangularBorder(border).borderMetrics:EdgeMetrics.EMPTY;
         }
         else
         {
         ...
         if(FlexVersion.compatibilityVersion >= FlexVersion.VERSION_3_0)
         {
            textField.x = textField.x + _loc4_;
            textField.y = textField.y + _loc6_;
