package mx.managers
{
   ...
   public class DragManagerImpl implements mx.managers.IDragManager
   {
      ...
      public function doDrag(param1:IUIComponent, param2:DragSource, param3:MouseEvent, param4:IFlexDisplayObject = null, param5:Number = 0, param6:Number = 0, param7:Number = 0.5, param8:Boolean = true) : void
      {
         ...
         if(!param4)
         {
            _loc18_ = StyleManager.getStyleDeclaration("DragManager");
            _loc19_ = _loc18_.getStyle("defaultDragImageSkin");
            param4 = new _loc19_();
         ...
         var _loc12_:Object = param3.target;
         if(_loc12_ == null)
         {
            _loc12_ = param1;
         }
         ...
         _loc13_ = DisplayObject(sandboxRoot).globalToLocal(_loc13_);
         var _loc14_:Number = _loc13_.x;
         ...
         dragProxy.x = _loc14_ - dragProxy.xOffset;
         dragProxy.y = _loc15_ - dragProxy.yOffset;
         ...
         var _loc17_:Object = dragProxy.automationDelegate;
         if(_loc17_)
         {
