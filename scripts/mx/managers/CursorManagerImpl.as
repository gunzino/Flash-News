package mx.managers
{
   ...
   public class CursorManagerImpl implements mx.managers.ICursorManager
   {
      ...
      public function removeCursor(param1:int) : void
      {
         ...
         {
            _loc4_ = cursorList[_loc2_];
            if(_loc4_.cursorID == param1)
            {
      ...
      {
         var _loc2_:int = sourceArray.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      private function mouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         _loc2_.x = _loc2_.x + currentCursorXOffset;
         _loc2_.y = _loc2_.y + currentCursorYOffset;
