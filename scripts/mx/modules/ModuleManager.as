   ...
   public function load(param1:ApplicationDomain = null, param2:SecurityDomain = null, param3:ByteArray = null) : void
   {
      ...
      else if(info.loaded)
      {
         if(info.setup)
         {
            ...
            if(info.ready)
            {
               _loc4_ = new ModuleEvent(ModuleEvent.PROGRESS);
               _loc4_.bytesLoaded = info.size;
...
class ModuleInfo extends EventDispatcher
{
   ...
   public function load(param1:ApplicationDomain = null, param2:SecurityDomain = null, param3:ByteArray = null) : void
   {
      ...
      _loc5_.applicationDomain = !!param1?param1:new ApplicationDomain(ApplicationDomain.currentDomain);
