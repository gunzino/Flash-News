package mx.graphics
{
   ...
   public class RectangularDropShadow
   {
      ...
      public function drawShadow(param1:Graphics, param2:Number, param3:Number, param4:Number, param5:Number) : void
      {
         ...
         var _loc6_:int = !!leftShadow?int(leftShadow.width):0;
         var _loc7_:int = !!rightShadow?int(rightShadow.width):0;
         var _loc8_:int = !!topShadow?int(topShadow.height):0;
         var _loc9_:int = !!bottomShadow?int(bottomShadow.height):0;
