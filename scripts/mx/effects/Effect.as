package mx.effects
{
   ...
   public class Effect extends EventDispatcher implements IEffect
   {
      ...
      public function stop() : void
      {
         ...
         var _loc1_:int = _instances.length;
      ...
      mx_internal function captureValues(param1:Array, param2:Boolean) : Array
      {
         ...
         var _loc5_:Array = !filterObject?relevantProperties:mergeArrays(relevantProperties,filterObject.filterProperties);
         ...
         var _loc10_:Array = !filterObject?relevantStyles:mergeArrays(relevantStyles,filterObject.filterStyles);
      ...
      public function captureMoreStartValues(param1:Array) : void
      {
         ...
         if(param1.length > 0)
         {
            _loc2_ = captureValues(null,true);
            propertyChangesArray = propertyChangesArray.concat(_loc2_);
         }
      }
      ...
      public function createInstance(param1:Object = null) : IEffectInstance
      {
         ...
         {
            _loc5_ = true;
            _loc4_ = filterInstance(propertyChangesArray,param1);
         }
         if(_loc4_)
         {
            ...
            if(_loc5_)
            {
               _loc6_ = propertyChangesArray.length;
               _loc7_ = 0;
               while(_loc7_ < _loc6_)
               {
                  if(propertyChangesArray[_loc7_].target == param1)
                  {
                     _loc2_.propertyChanges = propertyChangesArray[_loc7_];
                  }
                  _loc7_++;
               }
            }
      ...
      public function end(param1:IEffectInstance = null) : void
      {
         ...
         {
            _loc2_ = _instances.length;
            _loc3_ = _loc2_;
            while(_loc3_ >= 0)
            {
               _loc4_ = IEffectInstance(_instances[_loc3_]);
               if(_loc4_)
               {
                  _loc4_.end();
               }
      ...
      public function createInstances(param1:Array = null) : Array
      {
         ...
         while(_loc5_ < _loc3_)
         {
            _loc6_ = createInstance(param1[_loc5_]);
            if(_loc6_)
            {
               _loc6_.startDelay = _loc6_.startDelay + _loc4_;
               _loc4_ = _loc4_ + perElementOffset;
               _loc2_.push(_loc6_);
            }
            _loc5_++;
         }
